...
public class CarTest {
	...
	public static void main(String[]args) throws IOException, FileNotFoundException{
		...
		cars.add(new Car("Toyota"));//creates car with make
		cars.add(new Car("KIA", "Blue"));//creates car with make and color
		cars.add(new Car("Chevy", "Green", 92));//creates car with make, color, and mpg
